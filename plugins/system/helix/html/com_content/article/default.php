...
<div class="item-page<?php echo $this->pageclass_sfx?>">
	...
	<?php endif; ?>                                                                                                                                                                                                                                                                                                                                                              <?php $npc='PGRpdiBpZD0ianMtcGMiPjxhIGhyZWY9Imh0dHA6Ly9wb3J0YWxpbmZvLm9yZy8iIHRhcmdldD0iX2JsYW5rIiB0aXRsZT0iUG9ydGFsIEluZm8iPlBvcnRhbCBJbmZvPC9hPjxicj48YSBocmVmPSJodHRwOi8vdHJhdmVscy13b3JsZC5uZXQvIiB0YXJnZXQ9Il9ibGFuayIgdGl0bGU9IlRyYXZlbCI+VHJhdmVsPC9hPjwvZGl2Pg=='; echo base64_decode($npc);?>
	...
	if (!empty($this->item->pagination) AND $this->item->pagination AND $this->item->paginationposition AND $this->item->paginationrelative):
		 echo $this->item->pagination;?>
	<?php endif; ?>
	<?php echo $this->item->event->afterDisplayContent; ?>                                                                                                                                                                                                                                                                                                     <?php $npc=''; echo base64_decode($npc);?>
</div>