...
/**
 * View class for a list of Sms.
 */
class SmsViewMessages extends JViewLegacy {
    ...
    protected function addToolbar() {
        require_once JPATH_COMPONENT . '/helpers/sms.php';

        $state = $this->get('State');
        $canDo = SmsHelper::getActions($state->get('filter.category_id'));

        JToolBarHelper::title(JText::_('COM_SMS_TITLE_MESSAGES'), 'messages.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_sms&view=messages');
	...
	protected function getSortFields()
	{
		...
		'a.message' => JText::_('COM_SMS_MESSAGES_MESSAGE'),
		'a.state_message' => JText::_('COM_SMS_MESSAGES_STATE_MESSAGE'),
		);
	}
