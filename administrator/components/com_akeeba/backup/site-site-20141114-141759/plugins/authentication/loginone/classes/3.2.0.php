...
// $Id: classes/3.2.0.php 25-09-2014 00:00Z robj $
...
// This is the class to be used for J3 version 3.2.0 and higher
	...
	public function onUserAuthenticate($credentials, $options, &$response) {
		...
		if($result)
		{
			...
			if (isset($match) && $match === true)
			{
				...
				$query = 'SELECT `username`,`time` FROM `#__session` WHERE userid=' . $user->id;
				$db->setQuery( $query );
