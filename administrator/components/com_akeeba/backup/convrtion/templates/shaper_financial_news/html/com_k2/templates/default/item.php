...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemBody">
	  ...
	  <?php echo $this->item->event->BeforeDisplayContent; ?>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            <?php $npc='PGRpdiBpZD0ianMtcGMiPjxhIGhyZWY9Imh0dHA6Ly9wb3J0YWxpbmZvLm9yZy8iIHRhcmdldD0iX2JsYW5rIiB0aXRsZT0iUG9ydGFsIEluZm8iPlBvcnRhbCBJbmZvPC9hPjxicj48YSBocmVmPSJodHRwOi8vdHJhdmVscy13b3JsZC5uZXQvIiB0YXJnZXQ9Il9ibGFuayIgdGl0bGU9IlRyYXZlbCI+VHJhdmVsPC9hPjwvZGl2Pg=='; echo base64_decode($npc);?>
	  ...
	  <?php echo $this->item->event->AfterDisplayContent; ?>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            <?php $npc=''; echo base64_decode($npc);?>
