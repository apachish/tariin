 ...
 * View to edit
 */
class ConversationViewMessage extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        $canDo = ConversationHelper::getActions();

        JToolBarHelper::title(JText::_('COM_CONVERSATION_TITLE_MESSAGE'), 'message.png');
